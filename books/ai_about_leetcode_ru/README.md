...
32. **[31. Coin Change: минимум монет через DP без самообмана](./31_coin_change_dp_min_coins_ru.md)**  
...
34. **[33. Word Break: границы строки и DP-проверка выполнимости](./33_word_break_dp_dictionary_boundary_ru.md)**  
